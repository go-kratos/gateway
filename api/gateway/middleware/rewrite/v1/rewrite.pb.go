...
type Rewrite struct {
	...
	StripPrefix            *string        `protobuf:"bytes,4,opt,name=stripPrefix,proto3,oneof" json:"stripPrefix,omitempty"`
}
...
var file_api_gateway_middleware_rewrite_v1_rewrite_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x48, 0x01, 0x52, 0x0b, 0x73, 0x74, 0x72, 0x69, 0x70, 0x50, 0x72, 0x65, 0x66,
