...
var file_gateway_config_v1_gateway_proto_rawDesc = []byte{
	...
	0x22, 0x8c, 0x01, 0x0a, 0x07, 0x42, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x12, 0x16, 0x0a, 0x06,
	...
	0x68, 0x65, 0x63, 0x6b, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22,
...
var file_gateway_config_v1_gateway_proto_goTypes = []interface{}{
	...
	(*RetryConditionHeader)(nil), // 8: gateway.config.v1.RetryCondition.header
...
var file_gateway_config_v1_gateway_proto_depIdxs = []int32{
	...
	9,  // 2: gateway.config.v1.Gateway.read_timeout:type_name -> google.protobuf.Duration
	9,  // 3: gateway.config.v1.Gateway.read_header_timeout:type_name -> google.protobuf.Duration
	9,  // 4: gateway.config.v1.Gateway.write_timeout:type_name -> google.protobuf.Duration
	9,  // 5: gateway.config.v1.Gateway.idle_timeout:type_name -> google.protobuf.Duration
	0,  // 6: gateway.config.v1.Endpoint.protocol:type_name -> gateway.config.v1.Protocol
	9,  // 7: gateway.config.v1.Endpoint.timeout:type_name -> google.protobuf.Duration
	...
	10, // 11: gateway.config.v1.Middleware.options:type_name -> google.protobuf.Any
	5,  // 12: gateway.config.v1.Backend.health_check:type_name -> gateway.config.v1.HealthCheck
	9,  // 13: gateway.config.v1.Retry.per_try_timeout:type_name -> google.protobuf.Duration
	7,  // 14: gateway.config.v1.Retry.conditions:type_name -> gateway.config.v1.RetryCondition
	8,  // 15: gateway.config.v1.RetryCondition.by_header:type_name -> gateway.config.v1.RetryCondition.header
