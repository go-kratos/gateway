...
var file_gateway_config_v1_gateway_proto_rawDesc = []byte{
	...
	0x9f, 0x03, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x6e,
	...
	0x74, 0x22, 0xef, 0x02, 0x0a, 0x08, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x12,
...
var file_gateway_config_v1_gateway_proto_depIdxs = []int32{
	...
	10, // 3: gateway.config.v1.Gateway.write_timeout:type_name -> google.protobuf.Duration
	10, // 4: gateway.config.v1.Gateway.idle_timeout:type_name -> google.protobuf.Duration
	0,  // 5: gateway.config.v1.Endpoint.protocol:type_name -> gateway.config.v1.Protocol
	10, // 6: gateway.config.v1.Endpoint.timeout:type_name -> google.protobuf.Duration
	3,  // 7: gateway.config.v1.Endpoint.middlewares:type_name -> gateway.config.v1.Middleware
	4,  // 8: gateway.config.v1.Endpoint.backends:type_name -> gateway.config.v1.Backend
	6,  // 9: gateway.config.v1.Endpoint.retry:type_name -> gateway.config.v1.Retry
	11, // 10: gateway.config.v1.Middleware.options:type_name -> google.protobuf.Any
	5,  // 11: gateway.config.v1.Backend.health_check:type_name -> gateway.config.v1.HealthCheck
	8,  // 12: gateway.config.v1.Backend.labels:type_name -> gateway.config.v1.Backend.LabelsEntry
	10, // 13: gateway.config.v1.Retry.per_try_timeout:type_name -> google.protobuf.Duration
	7,  // 14: gateway.config.v1.Retry.conditions:type_name -> gateway.config.v1.RetryCondition
	9,  // 15: gateway.config.v1.RetryCondition.by_header:type_name -> gateway.config.v1.RetryCondition.header
