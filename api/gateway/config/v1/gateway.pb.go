...
type Retry struct {
	...
	AllowTriedNodes bool                 `protobuf:"varint,4,opt,name=allow_tried_nodes,json=allowTriedNodes,proto3" json:"allow_tried_nodes,omitempty"`
}
...
func (x *Retry) GetConditions() []string {
	if x != nil {
		return x.Conditions
	}
	return nil
...
func (x *Retry) GetAllowTriedNodes() bool {
	if x != nil {
		return x.AllowTriedNodes
	}
	return false
}
...
var file_gateway_config_v1_gateway_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x22, 0xb2, 0x01, 0x0a, 0x05, 0x52, 0x65, 0x74, 0x72,
	...
	0x12, 0x2a, 0x0a, 0x11, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x5f, 0x74, 0x72, 0x69, 0x65, 0x64, 0x5f,
	0x6e, 0x6f, 0x64, 0x65, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x61, 0x6c, 0x6c,
	0x6f, 0x77, 0x54, 0x72, 0x69, 0x65, 0x64, 0x4e, 0x6f, 0x64, 0x65, 0x73, 0x2a, 0x1e, 0x0a, 0x08,
	0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x12, 0x08, 0x0a, 0x04, 0x48, 0x54, 0x54, 0x50,
	0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x47, 0x52, 0x50, 0x43, 0x10, 0x01, 0x42, 0x34, 0x5a, 0x32,
...
var file_gateway_config_v1_gateway_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_gateway_config_v1_gateway_proto_depIdxs = []int32{
	...
	7,  // 3: gateway.config.v1.Endpoint.timeout:type_name -> google.protobuf.Duration
	...
	8,  // 7: gateway.config.v1.Middleware.options:type_name -> google.protobuf.Any
	5,  // 8: gateway.config.v1.Backend.health_check:type_name -> gateway.config.v1.HealthCheck
	7,  // 9: gateway.config.v1.Retry.per_try_timeout:type_name -> google.protobuf.Duration
