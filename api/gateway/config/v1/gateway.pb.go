...
type Retry struct {
	...
	// for http examples: 500-599;429
	// for grpc examples: internal;resource-exhausted;unavailable;cancelled;deadline-exceeded
...
func (x *RetryConditionByStatusCode) GetStatusCodes() []uint32 {
	if x != nil {
...
var file_gateway_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
