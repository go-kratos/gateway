...
type Gateway struct {
	...
	StreamEndpoints []*Endpoint `protobuf:"bytes,7,rep,name=stream_endpoints,json=streamEndpoints,proto3" json:"stream_endpoints,omitempty"`
}
...
func (x *Gateway) GetStreamEndpoints() []*Endpoint {
	if x != nil {
		return x.StreamEndpoints
	}
	return nil
}
...
var file_gateway_config_v1_gateway_proto_rawDesc = []byte{
	...
	0xb1, 0x03, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x6e,
	...
	0x73, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x12, 0x46, 0x0a, 0x10, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d,
	...
	0x67, 0x2e, 0x76, 0x31, 0x2e, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x0f, 0x73,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x1a, 0x53,
	...
	0x32, 0x16, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69,
	...
	0x6e, 0x74, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x67, 0x61, 0x74, 0x65,
	0x77, 0x61, 0x79, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x76, 0x31, 0x2e, 0x45, 0x6e,
	0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x09, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74,
	0x73, 0x22, 0x87, 0x04, 0x0a, 0x08, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x12,
...
var file_gateway_config_v1_gateway_proto_depIdxs = []int32{
	...
	4,  // 3: gateway.config.v1.Gateway.stream_endpoints:type_name -> gateway.config.v1.Endpoint
	...
	14, // 6: gateway.config.v1.Endpoint.timeout:type_name -> google.protobuf.Duration
	...
	11, // 10: gateway.config.v1.Endpoint.metadata:type_name -> gateway.config.v1.Endpoint.MetadataEntry
	15, // 11: gateway.config.v1.Middleware.options:type_name -> google.protobuf.Any
	7,  // 12: gateway.config.v1.Backend.health_check:type_name -> gateway.config.v1.HealthCheck
	12, // 13: gateway.config.v1.Backend.metadata:type_name -> gateway.config.v1.Backend.MetadataEntry
	14, // 14: gateway.config.v1.Retry.per_try_timeout:type_name -> google.protobuf.Duration
	9,  // 15: gateway.config.v1.Retry.conditions:type_name -> gateway.config.v1.Condition
	13, // 16: gateway.config.v1.Condition.by_header:type_name -> gateway.config.v1.Condition.header
